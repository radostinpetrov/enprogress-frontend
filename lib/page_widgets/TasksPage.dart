...
class TasksPage extends StatefulWidget {
  ...
  TasksPage({this.data, this.user, this.signoutCallback});
  ...
  static Future<bool> sendFcmMessage(String title, String message) async {
    try {
      ...
      var request = {
        ...
        'priority': 'high',
        'to': 'e9YGfZ-1rrE:APA91bGhbbRsGPDgkcSXEp3wFmmSgiL8343nQmkXO1Y9svKKN_tzcBbFQkASjsBKIP6e-oeF3PdYL1HM-61KzaSuyjuHSv1haPYvOlcaUsQNazXDy-OQ5lGeI098HXLQ51qx33GvN6l_'
      };
...
//  }
  ...
  TasksPageState({this.data, this.user, this.signoutCallback});
...
//                          _showNotificationWithoutSound();
                    print("oioi");
                    if (await sendFcmMessage("Hello World", "Look at me im Mr. Meeesiks")) {
                      print('yay');
                    }
                  },
                  child: Icon(
